...
static level_quad_t level3_sector1_quads[] = {
    ...
    { .pos = {38, -1, -9}, .rot = {0, 90, 0}, .size = {24, 10}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f}, .sector_id = 1, .portal_id = 0 },
...
static inline level_data_t load_3(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {30.506f, 3.500f, 9.276f}, .yaw = 615.959f, .pitch = -2.000f }
    };
}
