...
static level_quad_t level3_sector0_quads[] = {
    ...
    { .pos = {-8, 23, 49}, .rot = {90, 0, 0}, .size = {28, 19}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
...
static level_quad_t level3_sector5_quads[] = {
    ...
    { .pos = {-19, -5, 35}, .rot = {0, 111, 0}, .size = {11, 14}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 5 },
    { .pos = {-24, -5, 45}, .rot = {0, 0, 0}, .size = {2, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 5 },
...
static level_sector_data_t level3_sectors[] = {
    ...
    { .id = 1, .light = {0.9f, 0.9f, 0.8f}, .quads = level3_sector1_quads, .quad_count = sizeof(level3_sector1_quads) / sizeof(level3_sector1_quads[0]) },
    { .id = 2, .light = {1.0f, 0.9f, 1.0f}, .quads = level3_sector2_quads, .quad_count = sizeof(level3_sector2_quads) / sizeof(level3_sector2_quads[0]) },
    { .id = 3, .light = {0.8f, 0.9f, 0.9f}, .quads = level3_sector3_quads, .quad_count = sizeof(level3_sector3_quads) / sizeof(level3_sector3_quads[0]) },
    { .id = 4, .light = {1.0f, 0.9f, 0.9f}, .quads = level3_sector4_quads, .quad_count = sizeof(level3_sector4_quads) / sizeof(level3_sector4_quads[0]) },
    { .id = 5, .light = {0.9f, 1.0f, 0.9f}, .quads = level3_sector5_quads, .quad_count = sizeof(level3_sector5_quads) / sizeof(level3_sector5_quads[0]) },
};
...
static inline level_data_t load_3(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {-19.445f, 3.500f, 15.924f}, .yaw = -375.376f, .pitch = -4.175f }
    };
}
