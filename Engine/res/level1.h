...
static level_quad_t level1_sector0_quads[] = {
    ...
    { .pos = {35, -1, 17}, .rot = {90, 161, 0}, .size = {11, 16}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-3, 2, 55}, .rot = {90, 0, 0}, .size = {30, 24}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-3, 2, 19}, .rot = {90, 0, 0}, .size = {30, 18}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-3, -10, -1}, .rot = {270, 0, 0}, .size = {38, 56}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {22, -10, 17}, .rot = {0, 0, 0}, .size = {13, 12}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = true, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {21, -10, 1}, .rot = {0, 0, 0}, .size = {14, 12}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {34, -10, 33}, .rot = {0, 90, 0}, .size = {2, 10}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.8f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {34, -1, 35}, .rot = {0, 90, 0}, .size = {4, 1}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.8f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {34, -10, 39}, .rot = {0, 90, 0}, .size = {2, 10}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.8f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {34, -10, 35}, .rot = {0, 90, 0}, .size = {4, 1}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.8f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 0 },
...
static level_quad_t level1_sector1_quads[] = {
    { .pos = {0, -8, 1}, .rot = {90, 0, 0}, .size = {21, 12}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {0, -8, -11}, .rot = {0, 0, 0}, .size = {12, 8}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = true, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {12, -8, -11}, .rot = {0, 41, 0}, .size = {12, 8}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {21, -8, -5}, .rot = {0, 90, 0}, .size = {6, 8}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {0, 0, 1}, .rot = {90, 0, 0}, .size = {21, 12}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    ...
    { .pos = {20, -10, 19}, .rot = {0, 90, 59}, .size = {12, 6}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {25, -7, 19}, .rot = {0, 90, 90}, .size = {12, 8}, .tex_id = 3, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 1 },
    ...
    { .pos = {22, 2, 19}, .rot = {0, 90, 90}, .size = {12, 11}, .tex_id = 0, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.8f, 0.6f, 0.6f}, .portal_id = 0, .sector_id = 1 },
    ...
    { .pos = {22, 1, 19}, .rot = {0, 90, 0}, .size = {12, 1}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.6f, 0.7f, 1.0f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {0, -8, -11}, .rot = {0, 90, 0}, .size = {4, 8}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = true, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {0, -8, -3}, .rot = {0, 90, 0}, .size = {4, 8}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = true, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 1 },
...
static inline level_data_t load_1(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {14.075f, -5.500f, 23.376f}, .yaw = 292.121f, .pitch = -10.213f }
    };
}
