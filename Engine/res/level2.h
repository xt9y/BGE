...
static level_quad_t level2_sector0_quads[] = {
    { .pos = {-7, -1, 16}, .rot = {90, 0, 0}, .size = {21, 15}, .tex_idx = 0, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.6f, 0.6f}, .sector_id = 0 },
};
...
static level_quad_t level2_sector2_quads[] = {
    { .pos = {8, 7, 22}, .rot = {0, 331, 0}, .size = {8, 6}, .tex_idx = 3, .is_solid = true, .is_invisible = false, .color = {0.5f, 1.0f, 1.0f}, .sector_id = 2 },
};
...
static inline level_data_t load_2(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {5.382f, 6.500f, 46.537f}, .yaw = -2248.562f, .pitch = -5.779f }
    };
}
