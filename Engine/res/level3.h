...
static level_quad_t level3_sector0_quads[] = {
    ...
    { .pos = {-35, 9, 50}, .rot = {90, 0, 0}, .size = {16, 25}, .tex_id = 3, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.7f, 0.7f, 0.7f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-35, -5, 51}, .rot = {90, 0, 0}, .size = {16, 25}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.7f, 0.7f, 0.7f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-8, 13, 50}, .rot = {90, 0, 0}, .size = {28, 20}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.7f, 0.7f, 0.7f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-8, 23, 50}, .rot = {90, 0, 0}, .size = {28, 20}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.7f, 0.7f, 0.7f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {3, -3, 7}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_id = 2, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-2, 17, 37}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_id = 2, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 0 },
...
static level_quad_t level3_sector1_quads[] = {
    ...
    { .pos = {12, 13, 29}, .rot = {0, 45, 0}, .size = {12, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {-8, 13, 41}, .rot = {0, 0, 0}, .size = {2, 10}, .tex_id = 3, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {7, 13, 49}, .rot = {0, 0, 0}, .size = {13, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {-4, 13, 30}, .rot = {0, 0, 0}, .size = {20, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 1 },
    { .pos = {-4, 13, 30}, .rot = {0, 107, 0}, .size = {12, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {1.0f, 1.0f, 1.0f}, .portal_id = 0, .sector_id = 1 },
};
...
static inline level_data_t load_3(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {-18.284f, 3.500f, 7.663f}, .yaw = -4217.637f, .pitch = -10.916f }
    };
}
