...
static level_quad_t level1_sector0_quads[] = {
    ...
    { .pos = {-3, -10, 55}, .rot = {0, 0, 0}, .size = {25, 12}, .tex_id = 1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.5f, 0.5f, 0.5f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-3, 1, 19}, .rot = {0, 90, 90}, .size = {12, 2}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {22, -10, 1}, .rot = {0, 90, 0}, .size = {2, 12}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-3, -10, 19}, .rot = {0, 0, 0}, .size = {2, 11}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {20, -10, 19}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-1, 1, 19}, .rot = {0, 90, 0}, .size = {12, 3}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = true, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {20, -10, 31}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-3, -10, 31}, .rot = {0, 0, 0}, .size = {2, 11}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {20, 1, 19}, .rot = {0, 90, 0}, .size = {12, 3}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {20, 1, 19}, .rot = {0, 90, 90}, .size = {12, 2}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {-3, 1, 19}, .rot = {0, 0, 0}, .size = {23, 3}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    { .pos = {-3, 1, 31}, .rot = {0, 0, 0}, .size = {23, 3}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
    ...
    { .pos = {0, -8, 1}, .rot = {0, 0, 0}, .size = {1, 10}, .tex_id = -1, .is_solid = true, .is_invisible = false, .is_billboard = false, .portal_side_flip = false, .color = {0.2f, 0.2f, 0.2f}, .portal_id = 0, .sector_id = 0 },
...
static inline level_data_t load_1(void)
{
    return (level_data_t){
        ...
        .cam = { .pos = {2.784f, -5.500f, 27.291f}, .yaw = 17.421f, .pitch = 3.087f }
    };
}
