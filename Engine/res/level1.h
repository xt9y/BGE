...
static level_quad_t level1_sector0_quads[] = {
    ...
    { .pos = {-3, 2, 19}, .rot = {0, 90, 90}, .size = {12, 30}, .tex_idx = 3, .is_solid = true, .is_invisible = false, .color = {0.1f, 0.1f, 0.1f} },
    ...
    { .pos = {22, -11, 17}, .rot = {0, 0, 0}, .size = {12, 13}, .tex_idx = 1, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    ...
    { .pos = {22, -10, 31}, .rot = {0, 0, 0}, .size = {12, 13}, .tex_idx = 0, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    ...
    { .pos = {-3, -10, 19}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
    ...
    { .pos = {22, -10, 33}, .rot = {0, 0, 0}, .size = {12, 13}, .tex_idx = 0, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    ...
    { .pos = {20, 1, 19}, .rot = {0, 90, 0}, .size = {12, 1}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
    { .pos = {-5, -10, 5}, .rot = {0, 90, 0}, .size = {18, 21}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {3, -6, 50}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {15, -6, 50}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_idx = 0, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {12, -6, 50}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_idx = 1, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {9, -6, 50}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_idx = 2, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {6, -6, 50}, .rot = {0, 0, 0}, .size = {2, 2}, .tex_idx = 3, .is_solid = true, .is_invisible = false, .color = {1.0f, 1.0f, 1.0f} },
    { .pos = {20, -10, 31}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
    { .pos = {-3, -10, 31}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
    { .pos = {-3, -10, 32}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
    { .pos = {-3, -10, 18}, .rot = {0, 0, 0}, .size = {2, 12}, .tex_idx = -1, .is_solid = true, .is_invisible = false, .color = {0.6f, 0.7f, 1.0f} },
